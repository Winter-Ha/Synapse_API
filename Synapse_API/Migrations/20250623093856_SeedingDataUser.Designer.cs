...
namespace Synapse_API.Migrations
{
    ...
    [Migration("20250623093856_SeedingDataUser")]
            ...
            modelBuilder.Entity("Synapse_API.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2025, 6, 23, 9, 38, 56, 388, DateTimeKind.Utc).AddTicks(3393),
                            Email = "admin@example.com",
                            FullName = "Administrator",
                            IsActive = true,
                            PasswordHash = "hashed_password_here",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 6, 23, 9, 38, 56, 388, DateTimeKind.Utc).AddTicks(3394)
                        },
                        new
                        {
                            UserID = 2,
                            CreatedAt = new DateTime(2025, 6, 23, 9, 38, 56, 388, DateTimeKind.Utc).AddTicks(3396),
                            Email = "student@example.com",
                            FullName = "Student",
                            IsActive = true,
                            PasswordHash = "hashed_password_here",
                            Role = 0,
                            UpdatedAt = new DateTime(2025, 6, 23, 9, 38, 56, 388, DateTimeKind.Utc).AddTicks(3396)
                        });
                });
